          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card card-navy card-outline">
                <div class="card-body">
<a href="{{ url_for('dataPengujian') }}" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">SVM+Lex</a>
<a href="{{ url_for('pengujian2') }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">SVM</a>
<a href="{{ url_for('pengujian3') }}" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Selisih</a>
</div>
</div>
</div>
</div>
...
<!-- End Paging -->
    ...
    <!-- <div class="card-deck"> -->
    <div class="text-center">
  <img src="{{url_for('static', filename='images/chart1.png')}}" class="rounded" alt="...">
  <img src="{{url_for('static', filename='images/chart2.png')}}" class="rounded" alt="...">
    </div>
    </div>
    </div>
    </div>
    ...
    <!-- End Grafik -->
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/dataset.png')}}" alt="">
                    <p class="card-text">Data-data diatas merupakan data yang belem melalui tahap pre-processing</p>
                    ...
                    <p class="card-text">Tahap Preprocessing Pada data Mentah</p>
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                                2560 Data
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/prep1.png')}}" alt="">
                    <img src="{{url_for('static', filename='images/prep2.png')}}" alt="">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/trainnew.png')}}" alt="">
                    <p class="card-text">Pemilihan Data Training secara Random</p>
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                                2306 Data
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/testnew.png')}}" alt="">
                    <p class="card-text">Pemilihan Data Training secara Random</p>
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidf.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    </div> </br>
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidftrain2.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidftest2.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidfvocab.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    </div> </br>
                    <div class="card text-center">
                    <div class="card-header">
                            Fungsi Kernel Linear SVM
                    </div>
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/svckernel.png')}}" alt="">
                    <p class="card-text">Kernel yang digunakan dalam pengujian ini merupakan Kernel Linear</p>
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    </div> </br>
                    <div class="card text-center">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/predict2.png')}}" alt="">
                    <p class="card-text">Prediksi Teks Hasil Pengolahan SVM</p>
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    </div> </br>
                    <div class="card text-center">
                    <div class="card-header">
                            Akurasi Pengujian Sistem SVM
                    </div>
                    <div class="card-body">
                    <!-- <img src="{{url_for('static', filename='images/tekspredict.png')}}" alt=""> -->
                    <!-- <p class="card-text">Prediksi Teks Hasil Pengolahan</p> -->
                    <a href="#" class="btn btn-primary">70,9</a>
                    </div>
                    </div> </br>
