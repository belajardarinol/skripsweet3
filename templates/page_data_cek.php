                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- <a href="/addtomaster" class="btn btn-primary" onclick="return confirm('Tambah Ke Data Master?')">Add to Master</a> -->
                            <a href="{url_for('addtomaster') }}" class="btn btn-success" data-toggle="modal" data-target="#addModal">Add to Master</a>
                            </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="chart-area">
                                        <form action="{{ url_for('addtomaster') }}" method="POST">
                                            <p>Username : </p>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <p> Note : </p>
                                            <h6>** Inputkan Username terlebih dahulu !!! </h6>
                                            </p><br>
                                            <button type="submit" class="btn btn-primary" onclick="return confirm('Tambah Ke Data Master?')">Submit</button><br>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <form action="{{ url_for('Cek') }}" method="POST">
                                        <div class="form-group">
                                          ...
                                          <!-- <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="removenum" value="{{ x[3]}}">
                                          </div> -->
                                          <div class="form-group">
                                            <input type="hidden" name="id" value="{{ x.0 }}">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="stemming_" value="{{ x[9]}}">
                                          </div>
                                          <div class="form-group">
                                            <input type="hidden" name="id" value="{{ x.0 }}">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="hasil_kelas_nonqe" value="{{ x[15]}}">
                                          </div>
