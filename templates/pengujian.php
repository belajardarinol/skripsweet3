          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card card-navy card-outline">
                <div class="card-body">
<a href="{{ url_for('dataPengujian') }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">SVM+Lex</a>
...
<!-- End Paging -->
  ...
  <img src="{{url_for('static', filename='images/chart2.png')}}" class="rounded" alt="...">
    ...
    <!-- End Grafik -->
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidftrain.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/tfidftest.png')}}" alt="">
                    <!-- <p class="card-text">Pemilihan Data Training secara Random</p> -->
                    <!-- <a href="\input2" class="btn btn-primary">Open Data</a> -->
                    </div>
                    <div class="card-footer text-muted">
                    ...
                    <div class="card-body">
                    <img src="{{url_for('static', filename='images/predictnew.png')}}" alt="">
                    ...
                    <div class="card text-center">
                    <div class="card-header">
                            Akurasi Pengujian Sistem SVM + Lexicon Based
                    </div>
                    <div class="card-body">
                    <!-- <img src="{{url_for('static', filename='images/tekspredict.png')}}" alt=""> -->
                    <!-- <p class="card-text">Prediksi Teks Hasil Pengolahan</p> -->
                    <a href="#" class="btn btn-primary">73,9</a>
                    </div>
                    </div> </br>
