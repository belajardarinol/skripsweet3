...
<body>
    ...
    <!-- End Top Search -->
                ...
                <!-- Content Row -->
                    ...
                    <td>
                        <a href="{url_for('addLatih') }}" class="btn btn-success" data-toggle="modal" data-target="#addModal">Tambah Data</a>
                    </td>
                                ...
                                <table class="table css-serial">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <a href="/hapuslatih/{{ row.0 }},{{ row.1 }}" class="btn btn-outline-danger" onclick="return confirm('Yakin ingin hapus?')">Hapus</a>
                                        </td>
                                        </tr>
